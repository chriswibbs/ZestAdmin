								...
								<ul class="nofitications-dropdown">
									...
									<li class="dropdown head-dpdn">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="#">
                                                   <div class="user_img"><img src="<?php echo base_url();?>public/images/alert-icon.png" alt=""></div>
                                                ...
                                                <li class="odd"><a href="#">
                                                    <div class="user_img"><img src="<?php echo base_url();?>public/images/info-icon.png" alt=""></div>
                                                   <div class="notification_desc">
                                                    <p>Feature update</p>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li>
                                                <a href="#">
                                                    <div class="user_img"><img src="<?php echo base_url();?>public/images/uap-disconnected.png" alt=""></div>
                                                    <div class="notification_desc">
